                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddl_perguntaRec" CssClass="form-control inpt" AutoPostBack="false">
                                        ...
                                        <asp:ListItem Text="Escola " Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="container-fluid">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-5">
                                        <asp:Button runat="server" ID="btn_cadastrar" CssClass="btn btn-success btn-lg btn-block" Text="Cadastrar" OnClientClick="CarregarCuriosidade();" OnClick="btn_cadastrar_Click" data-toggle="modal" data-target=".modal-loading" ValidationGroup="vld_cadastro" />
                                    </div>
